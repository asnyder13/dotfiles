...
local dap_on_attach = function(bufnr)
	...
	map('n', '<Leader>dB',   function() dap.set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, o('conditional breakpoint'))
	map('n', '<Leader>lp',   function() dap.set_breakpoint(nil,                                         nil, vim.fn.input('Log print message: ')) end, o('log breakpoint'))
